...
pub struct SectionProperty {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub header: Option<(Header, String)>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub first_header_reference: Option<HeaderReference>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub first_header: Option<(Header, String)>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub even_header_reference: Option<HeaderReference>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub even_header: Option<(Header, String)>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl SectionProperty {
    ...
    pub fn even_header(mut self, h: Header, rid: &str) -> Self {
        ...
        self.even_header = Some((h, rid.to_string()));
        self
    }
    ...
    pub fn get_headers(&self) -> Vec<&(Header, String)> {
        let mut headers = vec![];
